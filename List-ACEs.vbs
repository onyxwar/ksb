'This script lists or removes the access control entries (ACEs) configured on BitLocker and TPM schema objects for the top-level domain. You can use this script to ensure that the expected ACEs have been added appropriately or to remove any ACEs related to BitLocker or the TPM. On a completed configuration without any delegation of permissions, there should be only one ACE related to the TPM. You can get usage information for the script by running the script with the -? parameter.
'Visual Basic
'=============================================================================== 
' 
