'This script demonstrates the retrieval of TPM recovery information from Active Directory Dpomain Services (AD DS) for a particular computer. You can use this script to verify that only domain administrators (or delegated roles) can read backed up TPM recovery information, and that the information is being backed up correctly.
