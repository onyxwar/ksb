...
'If you want to use this script with a domain controller running Windows Server 2003 with Service Pack 1 or later service packs, the Active Directory schema must be extended. For more information, including the steps required to enable schema updates, see article 285172 in the Microsoft Knowledge Base. Windows Server 2008 or Windows Server 2008 R2 domain controllers include the necessary schema extensions by default.
